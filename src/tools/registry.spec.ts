...
describe('registry', () => {
  it('lista las 17 tools registradas (Fase 2.2 + Fase 3.1 Canvas + Fase 4.2 Calendar + Fase 5.2 runCode + Fase 5.4 orquestación + Fase 5.5 pods de servicio + Fase 7.3 MCP) con su nivel correcto', () => {
  ...
  it('las 17 tools traen un inputSchema tipo objeto (Fase 5.1: requerido para tool-use)', () => {
    const tools = listRegisteredTools();
